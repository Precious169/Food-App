                ...
                <div className="max-w-[1440px] mx-auto px-6 md:px-10">
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-12">
                        ...
                        <div className="flex gap-4">
                            <Link href="/menu" className="h-14 px-8 bg-primary text-white font-bold rounded-full flex items-center justify-center shadow-lg shadow-primary/20 hover:scale-105 transition-all">
                                Order Now
                            </Link>
                        </div>
                    </div>
