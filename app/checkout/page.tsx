...
export default function CheckoutPage() {
    ...
    useEffect(() => {
        ...
        // Security check: If no items in cart, they shouldn't be here
        ...
        <div className="flex flex-col min-h-screen bg-background-light dark:bg-background-dark">
            ...
            <main className="flex-1 max-w-7xl mx-auto w-full px-6 md:px-10 py-10">
                <div className="flex items-center gap-3 mb-8">
                    <Link href="/cart" className="w-10 h-10 rounded-full bg-white dark:bg-[#2d1a1c] border border-[#e5dcdd] dark:border-[#3d2a2d] flex items-center justify-center text-[#886369] hover:text-primary hover:border-primary transition-all">
                        <span className="material-symbols-outlined text-xl">arrow_back</span>
                    </Link>
                    <h1 className="text-3xl md:text-4xl font-black text-[#181112] dark:text-white">Checkout</h1>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
                    ...
                    <form onSubmit={handlePlaceOrder} className="lg:col-span-8 space-y-6">
                        ...
                        {/* Details Section */}
                        <div className="bg-white dark:bg-[#2d1a1c] p-6 md:p-8 rounded-[2.5rem] border border-[#e5dcdd] dark:border-[#3d2a2d] shadow-sm">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="space-y-1.5">
                                    ...
                                    <input required type="text" placeholder="Your Name" className="w-full h-12 px-5 rounded-xl bg-background-light dark:bg-background-dark border border-[#e5dcdd] dark:border-[#3d2a2d] outline-none focus:ring-2 focus:ring-primary transition-all" />
                                </div>
                                <div className="space-y-1.5">
                            ...
                            {orderType === "delivery" && (
                                <div className="mt-6 space-y-4 animate-in fade-in slide-in-from-top-2">
                                    <div className="space-y-1.5">
                                        ...
                                        <input required type="text" placeholder="Street Address" className="w-full h-12 px-5 rounded-xl bg-background-light dark:bg-background-dark border border-[#e5dcdd] dark:border-[#3d2a2d] outline-none focus:ring-2 focus:ring-primary transition-all mb-3" />
                    ...
                    <div className="lg:col-span-4 space-y-6 lg:sticky lg:top-10">
                        <div className="bg-white dark:bg-[#2d1a1c] p-6 md:p-8 rounded-[2.5rem] border border-[#e5dcdd] dark:border-[#3d2a2d] shadow-md">
